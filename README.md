...
Brittany is the project leader, documentation lead, and quality reviewer. She keeps the team organized, tracks assignment requirements, reviews grammar and formatting, and makes sure the final deliverables are complete.

### Garrett

Garrett is responsible for backend development and report-generation logic. He focuses on making sure the prototype can process incident details and generate structured report sections.

### Mike

Mike is responsible for frontend development and the demo workflow. He focuses on making the prototype easy to use, readable, and ready to present.

## Milestones Complete and To Be Completed Each Week

| Week | Milestones Complete | Milestones To Be Completed |
|---|---|---|
| Week 1 | Team formed and project topic selected. | Finish setup notes and confirm project direction. |
| Week 2 | Project plan, timeline, and schedule created. | Prepare the repository and organize the prototype files. |
| Week 3 | Updated prototype created and README prepared. | Create public GitHub repository, upload source code, and submit the repository URL. |
| Week 4 | Report structure and 5 Whys section planned. | Improve report quality and test with more incident examples. |
| Week 5 | Technical and executive report styles planned. | Improve report style options and user feedback. |
| Week 6 | Testing and documentation plan started. | Complete testing evidence, screenshots, and setup notes. |
| Week 7 | Demo and presentation responsibilities assigned. | Draft presentation and practice the demo. |
| Week 8 | Final submission plan created. | Complete final documentation, final demo, and final submission. |
