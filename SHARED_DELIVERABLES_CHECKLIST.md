# Team 1 Shared Deliverables Checklist

Project: Security Incident Postmortem: Automated After-Action Report (AAR) Generator
Team: Brittany, Garrett, Mike
Class: CSC 482 Capstone Project II

## How To Use This Checklist

- Review this checklist during every team meeting.
- Mark items complete only when the file, screenshot, demo, or written proof exists.
- Add the owner's name beside new tasks immediately.
- Keep `MEETING_LOG.md` updated so attendance, assigned work, and completion status are easy to prove.
- Keep final submission files separate from drafts.
- Use this checklist to decide what still needs work before the final presentation.
...
Expected due date: Sunday by 11:59 PM  
Submission type: PDF file upload  
Instructor focus: individual contribution, GitHub achievements, testing evidence, and meeting attendance.
...
Purpose: Present the completed AAR Generator and demonstrate the working prototype.

- [ ] Brittany presents project purpose, documentation, final report, quality review, and team organization.
- [ ] Garrett presents backend workflow, LLM integration, testing evidence, and fallback plan.
- [ ] Mike presents frontend workflow, user input form, generated report display, and live demo flow.
- [ ] Team completes the live prototype demonstration.
- [ ] Team answers questions about project scope, testing, lessons learned, and future improvements.
- [ ] Team uses backup screenshots or a backup generated report if the live demo has technical issues.
...
Use this section during team meetings.
